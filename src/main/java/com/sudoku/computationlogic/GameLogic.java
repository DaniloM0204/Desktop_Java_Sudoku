...
public class GameLogic {
  ...
  public static boolean sudokuIsInvalid(int[][] grid) {
    ...
    if (squaresAreInvalid(0, 0, grid)) return true; else return false;
  }
  ...
  private static boolean squaresAreInvalid(
    int yIndex,
    int xIndex,
    int[][] grid
  ) {
  ...
  public static boolean squaresAreInvalid(int[][] newPuzzle) {
    return false;
  }
}
